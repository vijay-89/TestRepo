...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>LG_ContractsOwnerAssignment</fullName>
        <field>OwnerId</field>
        <lookupValue>Contracts_Local</lookupValue>
        <lookupValueType>Queue</lookupValueType>
        <name>LG_ContractsOwnerAssignment</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <rules>
        <fullName>LG_NewRecordOwnerAssignmentContracts</fullName>
        <actions>
            <name>LG_ContractsOwnerAssignment</name>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Contracts__c.Stage__c</field>
            <operation>equals</operation>
            <value>Not Started</value>
        </criteriaItems>
        <criteriaItems>
            <field>Contracts__c.Not_Started_Date_Completed__c</field>
            <operation>equals</operation>
        </criteriaItems>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>WF01_Contracts_Approved_Declined_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF02_Contracts_Not_Started_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF03_Contracts_Pending_Correction_Date</fullName>
        <actions>
        ...
        <criteriaItems>
            <field>Contracts__c.Stage__c</field>
            <operation>equals</operation>
            <value>Pending Correction</value>
        </criteriaItems>
    ...
    <rules>
        <fullName>WF05_Contracts_Pending_To_Approved_Declined</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF06_Contracts_Pending_To_Not_Started</fullName>
        <actions>
