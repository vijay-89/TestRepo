...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>LG_OwnerAssignment</fullName>
        <field>OwnerId</field>
        <lookupValue>Enrollment_and_Billing_Local</lookupValue>
        <lookupValueType>Queue</lookupValueType>
        <name>LG_MembershipOwnerAssignment</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <rules>
        <fullName>LG_NewRecordOwnerAssignment</fullName>
        <actions>
            <name>LG_OwnerAssignment</name>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Enrollment_and_Billing__c.Stage__c</field>
            <operation>equals</operation>
            <value>01 Not Started</value>
        </criteriaItems>
        <criteriaItems>
            <field>Enrollment_and_Billing__c.Not_Started_Date_Completed__c</field>
            <operation>equals</operation>
        </criteriaItems>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>WF01_ENROLLBILL_Approved_Declined_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF02_ENROLLBILL_Not_Started_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF03_ENROLLBILL_Pending_Correction_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF05_ENROLLBILL_Pending_To_Approved_Declined</fullName>
        <actions>
