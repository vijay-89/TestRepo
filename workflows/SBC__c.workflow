...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        ...
        <formula>TODAY()</formula>
        <name>PendingCorrection to Not Started</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>SBC__c.Stage__c</field>
            <operation>equals</operation>
            <value>01 Not Started</value>
        </criteriaItems>
        <criteriaItems>
            <field>SBC__c.Not_Started_Date_Completed__c</field>
            <operation>equals</operation>
        </criteriaItems>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>WF01_SBC_Approved_Declined_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF02_SBC_Not_Started_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF03_SBC_Pending_Correction_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF05_SBC_Pending_To_Approved_Declined</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF06_SBC_Pending_To_Not_Started</fullName>
        <actions>
