...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Assign_Owner_To_InterPlan_Local_Queue</fullName>
        <field>OwnerId</field>
        <lookupValue>Interplan_Local</lookupValue>
        <lookupValueType>Queue</lookupValueType>
        <name>Assign Owner To InterPlan Local Queue</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <rules>
        <fullName>Assign InterPlan Owner</fullName>
        <actions>
            <name>Assign_Owner_To_InterPlan_Local_Queue</name>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>InterPlan__c.Stage__c</field>
            <operation>equals</operation>
            <value>01 Not Started</value>
        </criteriaItems>
        <criteriaItems>
            <field>InterPlan__c.Not_Started_Date_Completed__c</field>
            <operation>equals</operation>
        </criteriaItems>
    ...
    <rules>
        <fullName>WF01_INTERPLAN_Approved_Declined_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF02_INTERPLAN_Not_Started_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF03_INTERPLAN_Pending_Correction_Date</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF05_INTERPLAN_Pending_To_Approved_Declined</fullName>
        <actions>
    ...
    <rules>
        <fullName>WF06_INTERPLAN_Pending_To_Not_Started</fullName>
        <actions>
